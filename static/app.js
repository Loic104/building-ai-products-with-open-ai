...
export default {
  ...
  template: `
  <div id="content" class="bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 flex items-center justify-center h-screen text-gray-800 text-lg fixed h-full w-full">
